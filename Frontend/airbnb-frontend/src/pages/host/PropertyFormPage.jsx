...
const fields = [
  {
    ...
    placeholder: 'El nombre que verán los huéspedes',
    type: 'text',
  },
  {
    name: 'description',
  ...
  },
  {
    name: 'location',
    label: 'Ubicación',
    placeholder: 'Ciudad o zona donde se encuentra la propiedad.',
    type: 'text',
  },
  {
    name: 'pricePerNight',
    label: 'Precio por noche',
    placeholder: 'Tarifa que pagarán los huéspedes por cada noche',
    type: 'number',
  },
  {
    name: 'capacity',
    label: 'Capacidad máxima',
    placeholder: 'Número máximo de personas que puede alojar la propiedad',
    type: 'number',
  },
];
